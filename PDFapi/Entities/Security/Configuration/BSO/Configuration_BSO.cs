...
namespace PDFapi.Security
{
    ...
    internal static class Configuration_BSO
    {
        ...
        internal static bool UpdateConfigFromFiles()
        {
            ...
            MemCacheD.Store_BSO("PDFapi.Security", "Configuration", "Read", ConfigType.global.ToString(), globalConfig, default(DateTime));
            MemCacheD.Store_BSO("PDFapi.Security", "Configuration", "Read", ConfigType.server.ToString(), serverConfig, default(DateTime));
